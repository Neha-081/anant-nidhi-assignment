...
export default function MemberForm() {
    return (
      <>
        ...
        <div className="hidden lg:block relative w-0 basis-2/4 mx-20">
            <Slider />
          </div>
          <div className="w-1/2 mx-10 flex flex-col ml-auto justify-center py-10 p-6 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-primary rounded-xl">
            <div className="mx-auto w-full w-full px-10 p-6 m-5 bg-white rounded-xl">
              <div>
                <h2 className="mt-6 text-3xl font-semibold text-gray-900">Become a member</h2>
              </div>
              <Tabs />
